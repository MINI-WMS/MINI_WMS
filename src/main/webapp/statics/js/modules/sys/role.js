$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			...
			{label: '修改用户', name: 'modifierName', width: 70, sortable: false},
			{label: '修改时间', name: 'modifyDate', width: 85, sortable: false},
			{label: '创建用户', name: 'creatorName', width: 70, sortable: false},
