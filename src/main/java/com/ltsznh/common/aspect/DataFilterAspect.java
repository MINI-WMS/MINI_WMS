...
public class DataFilterAspect {
	...
	@Pointcut("@annotation(com.ltsznh.common.annotation.DataFilter)")
	...
	public void dataFilter(JoinPoint point) throws Throwable {
		...
		if (params != null && params instanceof Map) {
			...
			if (
//                    user.getUserId() != Constant.SUPER_ADMIN &&
					user.getUserType() != 2) {
				Map map = (Map) params;
		...
		throw new FamilyException("要实现数据权限接口的参数，只能是Map类型，且不能为NULL");
	}
