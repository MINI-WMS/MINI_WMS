 ...
 */
public class WmsTransferOrderPurRowEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	
	//转储单编号
	private Long toPurRowId;
	//转储单日期
	private Date toDate;
	//转储单号
	private String toNo;
	 ...
	 * 设置：转储单编号
	 */
	public void setToPurRowId(Long toPurRowId) {
		this.toPurRowId = toPurRowId;
	}
	/**
	 * 获取：转储单编号
	 */
	public Long getToPurRowId() {
		return toPurRowId;
	}
	/**
	 * 设置：转储单日期
